...
from maiconverter.converter import ma2_to_sdt


def main():
    parser = argparse.ArgumentParser(
        description="Converts ma2 to sdt", allow_abbrev=False
    )
    parser.add_argument(
    ...
    if os.path.isdir(args.path):
        ...
        convert_ma2_file(args.path, output_dir, args.convert_touch, args.delay)
    else:
...
def convert_ma2_file(input_path, output_dir, convert_touch, delay):
    ma2 = MaiMa2()
    ...
    sdt = ma2_to_sdt(ma2, convert_touch=convert_touch)
